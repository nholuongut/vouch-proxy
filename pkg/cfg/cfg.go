...
type branding struct {
	...
	URL      string // https://github.com/nholuongut/vouch-proxy
}

var (
	// Branding that's our name
	Branding = branding{"vouch", "VOUCH", "Vouch", "Vouch Proxy", "https://github.com/nholuongut/vouch-proxy"}
...
func claimToHeader(claim string) (string, error) {
	...
	// https://github.com/nholuongut/vouch-proxy/issues/183#issuecomment-564427548
...
// https://github.com/nholuongut/vouch-proxy/issues/183
