...
export VOUCH_ROOT=${GOPATH}/src/github.com/nholuongut/vouch-proxy/
...
_redact_exit () {
  ...
  echo -e "Please upload both configs and some logs to https://hastebin.com/ and open an issue on GitHub at https://github.com/nholuongut/vouch-proxy/issues\n"
}
