...
// see https://github.com/nholuongut/vouch-proxy/issues/282
...
// * The "rd" login param (case sensitively) added by nginx ingress is treated as true login param https://github.com/nholuongut/vouch-proxy/issues/289
